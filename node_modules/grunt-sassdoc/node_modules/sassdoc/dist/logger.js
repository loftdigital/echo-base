...
var Logger = (function () {
  function Logger() {
    ...
    _to5Helpers.classCallCheck(this, Logger);
  ...
  Logger.prototype.log = function log() {
    ...
    if (this.verbose) {
      var str = fmt.apply(undefined, ["" + green + " " + args.shift()].concat(args));
  ...
  Logger.prototype.warn = function warn() {
    ...
    chalkHack(function () {
      var str = fmt.apply(undefined, ["" + yellow + " " + br("WARNING") + " " + args.shift()].concat(args));
  ...
  Logger.prototype.error = function error() {
    ...
    chalkHack(function () {
      var str = fmt.apply(undefined, ["" + red + " " + br("ERROR") + " " + args.shift()].concat(args));
      _this._stderr.write("" + str + "\n");
    });
  };
  ...
  Logger.prototype.debug = function debug() {
    ...
    chalkHack(function () {
      var str = fmt.apply(undefined, ["" + chalk.styles.grey.open + "" + chevron + " " + br("DEBUG") + " " + args.shift()].concat(args, [chalk.styles.grey.close]));
